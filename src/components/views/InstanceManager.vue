<template>
    <div id="instance_manager">
        ...
        <!--  任务实例详情弹出框 -->
        <el-dialog :visible.sync="instanceDetailVisible" v-if='instanceDetailVisible' :close-on-click-modal="false" width="80%">
            <InstanceDetail :instance-id="currentInstanceId"/>
        </el-dialog>

        <!-- 任务运行日志弹出框 -->
        <el-dialog :visible.sync="instanceLogVisible" :close-on-click-modal="false" width="80%">
            <el-row>
